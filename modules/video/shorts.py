...
def generate_video(clip):
    video = VideoFileClip(f'content/shorts/{sanitize_path(clip.title)}' + "/raw_clip.mp4")#.subclip(0, 1)
    ...
    output_path = os.path.join(f'content/shorts/{sanitize_path(clip.title)}', "product" + ".mp4")
